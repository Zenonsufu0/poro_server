...
| [`domains/poromon.md`](domains/poromon.md) | Zenon Mon 도메인 (인증 구현, 조회/알림 TODO) |
...
| 멀티서버 온보딩(공통 디스코드 인증 → 서버별 약관동의 → 서버별 화이트리스트, DL-131) | 🟢 공통 온보딩 + RPG/Zenon Mon 인증 라우팅 구현 |
| 배포(오라클 상시 운영, 게임 호스팅 분리, DL-131) | 🔴 미구성 |
| Zenon Mon 연동·명령어 | 🟡 인증 구현, 조회 명령어·운영 API TODO |
